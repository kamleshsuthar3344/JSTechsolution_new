...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $error = loginUser($email, $password, 'referral');
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Referral Login | Earning Sharthi</title>
...
<body>
    <div class="auth-container">
        ...
        <h1 class="auth-title">Referral Login</h1>
        ...
        <form action="" method="POST">
            ...
            <div class="form-group" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <a href="../forgot_password.php?type=referral" style="font-size: 14px; color: var(--primary);">Forgot Password?</a>
            </div>
        ...
        <div class="auth-footer">
            ...
            <a href="../register.php?type=referral">Join as Referrer</a>
        </div>
    </div>
</body>
</html>
